...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("Average cost of Veg Food :- "+bo.avgCostByCategory(Type.VEG));
		System.out.println("Average cost of Non-Veg Food :- "+bo.avgCostByCategory(Type.NON_VEG));
		System.out.println("\n\n-----------------\n\n");
